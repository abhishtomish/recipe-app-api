...
def sample_tag(user, name="Mail Course"):
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Aburgene with tahini')
        tag1 = sample_tag(user=self.user, name='Vegan')
        tag2 = sample_tag(user=self.user, name='Vegiterian')
